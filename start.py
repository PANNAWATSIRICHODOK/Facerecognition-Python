...
def OpenCam():
    ...
    result = cv2.VideoWriter('CapCam.avi', fourcc, 20.0,
    ...
    while True:
        ...
        for face_loc, name in zip(face_locations, face_names):
            ...
            if name not in stdnames and name != 'Unknown':
        ...
        cv2.putText(frame, Date, (10, 30), cv2.FONT_HERSHEY_SIMPLEX,
                    0.8, (0, 255, 255), cv2.LINE_4)
...
lb1 = Label(text='\n\n').pack()
btn1 = Button(root, text='Start Face Recognition', fg='yellow',
              font=30, bg='black', command=OpenCam).pack()
lb2 = Label(text='\n').pack()
btn2 = Button(root, text='NameList', fg='yellow', font=30,
              bg='black', command=showname).pack()
